...
public class WagonController2 implements WagonInputAdapter {
    ...
    public boolean addNewWagon(String numberFreight, String typeName, WagonCode code, int lengthOverBuffers, int wagonNumberOfAxles, int brakeWeightG, int brakeWeightP, int wagonWeightEmpty, int maxSpeed) {
	...
	@Override
	public Wagon getByCode(WagonCode code, boolean check) {
		return null;
	}
}
